...
parser.add_argument('--generator_G', type=str, default='checkpoint/727/netG_40.pth', help='generator checkpoint file')
...
for i, batch in enumerate(dataloader):
    ...
    k=0
    save_image(fake_B, fakeB_path+'/{}.jpg'.format(k+int(filename)),padding=0)    
